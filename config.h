...
static char *font2[] = { "SauceCodePro Nerd Font Mono:pixelsize=18:antialias=true:autohint=true" };
...
static char *openurlcmd[] = { "/bin/bash", "-c", "st-urlhandler", "externalpipe", NULL };
